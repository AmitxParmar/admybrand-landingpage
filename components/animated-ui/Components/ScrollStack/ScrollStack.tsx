...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const handleNestedScroll = useCallback((e: Event) => {
    const scroller = scrollerRef.current;
  ...
  useLayoutEffect(() => {
    ...
    cards.forEach((card, i) => {
      ...
      // Add event listener for nested scroll
      card.addEventListener("scroll", handleNestedScroll);
    });
    ...
    return () => {
      ...
      // Remove event listeners for nested scroll
      cards.forEach((card) => {
        card.removeEventListener("scroll", handleNestedScroll);
      });
    };
  }, [
    itemDistance,
